...
if(isset($_arguments["do"])&& ($_arguments["do"] != "")){
    ...
    }else if(($_arguments["do"] == "add_first_term_result")){//MSK-000143-add_first_term_result 
		$page = "model/add_first_term_result.php";
	}else if(($_arguments["do"] == "add_second_term_result")){//MSK-000143-add_first_term_result 
		$page = "model/add_second_term_result.php";
    }else if(($_arguments["do"] == "add_third_term_result")){//MSK-000143-add_first_term_result 
		$page = "model/add_third_term_result.php";
    }else if(($_arguments["do"] == "update_first_result2")){//MSK-000143-add_first_term_result 
		$page = "model/update_first_result2.php";
    }else if(($_arguments["do"] == "add_payment")){//MSK-000143-add_first_term_result 
		$page = "model/add_payment.php";
     }   																				
}else{
